...
abstract class Lexical(val word: String) {
  ...
  def addMorphs(morphs: mutable.MutableList[Morph]) {
    morphs.foreach(addMorph)
  }

  def getHwds: mutable.HashSet[String]

  protected def analyzeMorphs()

  def generateCell(bagOfHwds: mutable.HashSet[String]): Cell
...
class WordLexical(word: String) extends Lexical(word) {
  ...
  def getHwds: mutable.HashSet[String] = {
    val hwds = new mutable.HashSet[String]
  ...
  private def reduceAsNoun(implicit form: String): mutable.MutableList[NounAspects] = {
    val list = new mutable.MutableList[NounAspects]
  ...
  def reduceAsVerb(implicit form: String): mutable.MutableList[VerbAspects] = {
    val list = new mutable.MutableList[VerbAspects]
  ...
  def reduceAsAdjective(implicit form: String): mutable.MutableList[AdjectiveAspects] = {
    val list = new mutable.MutableList[AdjectiveAspects]
    if (endsWith("er")) {
      if (endsWith("ier")) {
